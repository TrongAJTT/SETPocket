...
class CurrencyFetchProgressDialog extends StatefulWidget {
  ...
  @override
  State<CurrencyFetchProgressDialog> createState() => _CurrencyFetchProgressDialogState();
}

class _CurrencyFetchProgressDialogState extends State<CurrencyFetchProgressDialog>
  ...
  String _getStatusText(AppLocalizations l10n, String currency, CurrencyStatus status) {
    switch (status) {
      case CurrencyStatus.success:
            ...
            Container(
              ...
              child: Column(
                children: [
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            return CircularProgressIndicator(
                              value: _isCompleted ? 1.0 : (1.0 - _progressAnimation.value),
                              strokeWidth: 8,
                              valueColor: AlwaysStoppedAnimation<Color>(
                  ...
                  // Progress text
                  Text(
                    l10n.fetchingProgress(_completedCount, widget.currencies.length),
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final status = _currencyStatuses[currency] ?? CurrencyStatus.staticRate;
