                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            l10n.numberSystemConverterDetailedInfo,
                          ...
                          Text(
                            l10n.numberSystemConverterOverview,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoSection(
                        ...
                        [
                          ...
                          _buildFeatureItem(theme, l10n.multipleUnits,
                              l10n.multipleUnitsDesc, Icons.code),
                      ...
                      _buildInfoSection(
                        ...
                        Colors.blue,
                        [
                          _buildStepItem(theme, l10n.step1NumberSystem,
                              l10n.step1NumberSystemDesc),
                          _buildStepItem(theme, l10n.step2NumberSystem,
                              l10n.step2NumberSystemDesc),
                          _buildStepItem(theme, l10n.step3NumberSystem,
                              l10n.step3NumberSystemDesc),
                          _buildStepItem(theme, l10n.step4NumberSystem,
                              l10n.step4NumberSystemDesc),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        ...
                        Colors.green,
                        [
                          _buildTipItem(theme, l10n.tip1NumberSystem),
                          _buildTipItem(theme, l10n.tip2NumberSystem),
                          _buildTipItem(theme, l10n.tip3NumberSystem),
                          _buildTipItem(theme, l10n.tip4NumberSystem),
                          _buildTipItem(theme, l10n.tip5NumberSystem),
                          _buildTipItem(theme, l10n.tip6NumberSystem),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        theme,
                        l10n.numberSystemUnitCategories,
                        Icons.code,
                        Colors.purple,
                        [
                          _buildCategoryItem(theme, l10n.commonUnits,
                              l10n.commonBasesDesc, Colors.green),
                          _buildCategoryItem(theme, l10n.lessCommonUnits,
                              l10n.lessCommonBasesDesc, Colors.orange),
                          _buildCategoryItem(theme, l10n.uncommonUnits,
                              l10n.uncommonBasesDesc, Colors.red),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        ...
                        [
                          Padding(
                            ...
                            child: Text(
                              l10n.practicalApplicationsNumberSystemDesc,
                              style: theme.textTheme.bodyMedium,
                            ),
                          ),
                        ],
