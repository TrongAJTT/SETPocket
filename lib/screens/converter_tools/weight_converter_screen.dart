                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            l10n.weightConverterDetailedInfo,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoSection(
                        ...
                        [
                          ...
                          _buildFeatureItem(theme, l10n.multipleUnits,
                              l10n.multipleUnitsDesc, Icons.fitness_center),
                      ...
                      _buildInfoSection(
                        ...
                        [
                          _buildStepItem(
                              theme, l10n.step1Weight, l10n.step1WeightDesc),
                          _buildStepItem(
                              theme, l10n.step2Weight, l10n.step2WeightDesc),
                          _buildStepItem(
                              theme, l10n.step3Weight, l10n.step3WeightDesc),
                          _buildStepItem(
                              theme, l10n.step4Weight, l10n.step4WeightDesc),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        ...
                        Colors.green,
                        [
                          _buildTipItem(theme, l10n.tip1Weight),
                          _buildTipItem(theme, l10n.tip2Weight),
                          _buildTipItem(theme, l10n.tip3Weight),
                          _buildTipItem(theme, l10n.tip4Weight),
                          _buildTipItem(theme, l10n.tip5Weight),
                          _buildTipItem(theme, l10n.tip6Weight),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        theme,
                        l10n.weightUnitCategories,
                        Icons.category,
                        Colors.purple,
                        [
                          _buildCategoryItem(theme, l10n.commonUnits,
                              l10n.commonUnitsWeightDesc),
                          _buildCategoryItem(theme, l10n.lessCommonUnits,
                              l10n.lessCommonUnitsWeightDesc),
                          _buildCategoryItem(theme, l10n.uncommonUnits,
                              l10n.uncommonUnitsWeightDesc),
                          _buildCategoryItem(theme, l10n.specialUnits,
                              l10n.specialUnitsWeightDesc),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        ...
                        [
                          Padding(
                            ...
                            child: Text(
                              l10n.practicalApplicationsWeightDesc,
                              style: theme.textTheme.bodyMedium,
                            ),
                          ),
                        ],
