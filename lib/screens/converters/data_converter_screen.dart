...
import '../../controllers/data_converter_controller.dart';
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            l10n.dataConverterDetailedInfo,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoSection(
                        ...
                        [
                          ...
                          _buildFeatureItem(theme, l10n.multipleUnits,
                              l10n.multipleUnitsDesc, Icons.storage),
                      ...
                      _buildInfoSection(
                        ...
                        [
                          _buildStepItem(
                              theme, l10n.step1Data, l10n.step1DataDesc),
                          _buildStepItem(
                              theme, l10n.step2Data, l10n.step2DataDesc),
                          _buildStepItem(
                              theme, l10n.step3Data, l10n.step3DataDesc),
                          _buildStepItem(
                              theme, l10n.step4Data, l10n.step4DataDesc),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        ...
                        Colors.green,
                        [
                          _buildTipItem(theme, l10n.tip1Data),
                          _buildTipItem(theme, l10n.tip2Data),
                          _buildTipItem(theme, l10n.tip3Data),
                          _buildTipItem(theme, l10n.tip4Data),
                          _buildTipItem(theme, l10n.tip5Data),
                          _buildTipItem(theme, l10n.tip6Data),
                        ],
                      ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  l10n.dataCommonUnitsDesc,
                                  style: theme.textTheme.bodySmall,
                                ),
                                const SizedBox(height: 12),
                                Text(
                                  l10n.dataLessCommonUnits,
                                  style: theme.textTheme.titleSmall?.copyWith(
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                      ...
                      _buildInfoSection(
                        ...
                        [
                          Padding(
                            ...
                            child: Text(
                              l10n.dataPracticalApplicationsDesc,
                              style: theme.textTheme.bodyMedium,
                            ),
                          ),
                        ],
