...
import 'package:setpocket/controllers/temperature_converter_controller.dart';
...
class _TemperatureConverterScreenState
  ...
  late TemperatureConverterController _controller;
  ...
  Future<void> _initializeController() async {
    _controller = TemperatureConverterController();
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            l10n.temperatureConverterDetailedInfo,
                          ...
                          Text(
                            l10n.temperatureConverterOverview,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoSection(
                        ...
                        [
                          ...
                          _buildFeatureItem(theme, l10n.multipleUnits,
                              l10n.multipleUnitsDesc, Icons.thermostat),
                      ...
                      _buildInfoSection(
                        ...
                        Colors.blue,
                        [
                          _buildStepItem(theme, l10n.step1Temperature,
                              l10n.step1TemperatureDesc),
                          _buildStepItem(theme, l10n.step2Temperature,
                              l10n.step2TemperatureDesc),
                          _buildStepItem(theme, l10n.step3Temperature,
                              l10n.step3TemperatureDesc),
                          _buildStepItem(theme, l10n.step4Temperature,
                              l10n.step4TemperatureDesc),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        ...
                        Colors.green,
                        [
                          _buildTipItem(theme, l10n.tip1Temperature),
                          _buildTipItem(theme, l10n.tip2Temperature),
                          _buildTipItem(theme, l10n.tip3Temperature),
                          _buildTipItem(theme, l10n.tip4Temperature),
                          _buildTipItem(theme, l10n.tip5Temperature),
                          _buildTipItem(theme, l10n.tip6Temperature),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        theme,
                        l10n.temperatureUnitCategories,
                        Icons.category,
                        Colors.purple,
                        [
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  l10n.temperatureCommonUnitsDesc,
                                  style: theme.textTheme.bodySmall,
                                ),
                                const SizedBox(height: 12),
                                Text(
                                  l10n.temperatureLessCommonUnits,
                                  style: theme.textTheme.titleSmall?.copyWith(
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                                const SizedBox(height: 4),
                                Text(
                                  l10n.temperatureLessCommonUnitsDesc,
                                  style: theme.textTheme.bodySmall,
                                ),
                                const SizedBox(height: 12),
                                Text(
                                  l10n.temperatureRareUnits,
                                  style: theme.textTheme.titleSmall?.copyWith(
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                      ...
                      _buildInfoSection(
                        ...
                        [
                          Padding(
                            ...
                            child: Text(
                              l10n.temperaturePracticalApplicationsDesc,
                              style: theme.textTheme.bodyMedium,
                            ),
                          ),
                        ],
    ...
    return ListenableBuilder(
      ...
      builder: (context, child) {
        return GenericConverterView(
          ...
          title: l10n.temperatureConverter,
          titleIcon: Icons.thermostat,
          onShowInfo: _showTemperatureInfo,
        );
      },
    );
  }
