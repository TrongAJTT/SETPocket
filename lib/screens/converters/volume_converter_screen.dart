                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            l10n.volumeConverterDetailedInfo,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoSection(
                        ...
                        [
                          _buildStepItem(
                              theme, l10n.step1Volume, l10n.step1VolumeDesc),
                          _buildStepItem(
                              theme, l10n.step2Volume, l10n.step2VolumeDesc),
                          _buildStepItem(
                              theme, l10n.step3Volume, l10n.step3VolumeDesc),
                          _buildStepItem(
                              theme, l10n.step4Volume, l10n.step4VolumeDesc),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        ...
                        Colors.green,
                        [
                          _buildTipItem(theme, l10n.tip1Volume),
                          _buildTipItem(theme, l10n.tip2Volume),
                          _buildTipItem(theme, l10n.tip3Volume),
                          _buildTipItem(theme, l10n.tip4Volume),
                          _buildTipItem(theme, l10n.tip5Volume),
                          _buildTipItem(theme, l10n.tip6Volume),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        theme,
                        l10n.volumeUnitCategories,
                        Icons.category,
                        Colors.purple,
                        [
                          _buildUnitCategoryItem(theme, l10n.commonUnits,
                              l10n.commonUnitsVolumeDesc),
                          _buildUnitCategoryItem(theme, l10n.lessCommonUnits,
                              l10n.lessCommonUnitsVolumeDesc),
                          _buildUnitCategoryItem(theme, l10n.uncommonUnits,
                              l10n.uncommonUnitsVolumeDesc),
                          _buildUnitCategoryItem(theme, l10n.specialUnits,
                              l10n.specialUnitsVolumeDesc),
                        ],
                      ),
                      ...
                      _buildInfoSection(
                        ...
                        [
                          Padding(
                            ...
                            child: Text(
                              l10n.practicalApplicationsVolumeDesc,
                              style: theme.textTheme.bodyMedium,
                            ),
                          ),
                        ],
